...
- 这里是是Twisuki, 中文名苏阳, 可以直接叫咱苏喵哒 ~ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div class="right">I'm Twisuki, Su Yang in Chinese.</div>
- 来自辽宁的一只猫~ <div class="right">A cat/neko from Liaoning Province, China.</div>
- 现就读于湖南大学, 学习人工智能 <div class="right"> Learning AI in HNU.</div>

### 自设/属性 Likes & Attributes

- 是一只什么都会一点又什么都不精的猫猫哒 <div class="right">There is a cat that knows everything, but a little bit.</div>
- 喜欢二次元, MBTI是ISFP <div class="right">Loves ACG and MBTI is ISFP.</div>
- 喜欢毛茸茸的东西, 喜欢到处贴贴~ <div class="right">I love fluffy things and enjoy cuddling with everything around~</div>
- 有一对可以收起来, 随着情绪变化的小猫耳 <div class="right">Has a pair of cat ears that can be tucked away and change according to emotions</div>
- 性取向为泛性恋, 性别存疑(?), 目前认为无性 &nbsp;&nbsp;&nbsp; <div class="right">Sexual orientation is Pansexual, gender is uncertain(?), currently considered Agender.</div>
