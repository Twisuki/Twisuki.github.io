...
& \ \\
& = \frac{\sum_{i = 1}^n x_i y_i + \overline{y} \sum_{i = 1}^n x_i - \overline{x} \sum_{i = 1}^n y_i + n \overline{x} \overline{y}}{\sqrt{\sum_{i = 1}^n x_i^2 - 2 \overline{x} \sum_{i = 1}^n x_i + n \overline{x}^2} \sqrt{\sum_{i = 1}^n y_i^2 - 2 \overline{y} \sum_{i = 1}^n y_i + n \overline{y}^2}} \ \cdots \overline{x}, \overline{y} \in R, \sum_{i = 1}^n \overline{x} = n \overline{x} \\
& \ \\
& = \frac{\sum_{i = 1}^n x_i y_i + n \overline{x} \overline{y} - n \overline{x} \overline{y} + n \overline{x} \overline{y}}{\sqrt{\sum_{i = 1}^n x_i^2 - 2 n \overline{x}^2 + n \overline{x}^2} \sqrt{\sum_{i = 1}^n y_i^2 - 2 n \overline{y}^2 + n \overline{y}^2}} \ \cdots \\
& \ \\
& = \frac{\sum_{i = 1}^n x_i y_i - n \overline{x} \overline{y}}{\sqrt{\sum_{i = 1}^n x_i^2 - n \overline{x}^2} \sqrt{\sum_{i = 1}^n y_i^2 - n \overline{y}^2}}
\end{aligned}
$$
